...
## La calculadora realiza operaciones como suma:
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/suma.png)
## Multiplicación: 
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/multiplicacion.png)
## División: 
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/divicion%20.png)
## Seno:
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/sin.png)
## Coseno:
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/cos.png)
## Tangente:
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/tan.png)
## Logaritmo:
![](https://github.com/Josselyn-Troya/scientific-calculator/blob/main/Images/log.png)
### Se implemento varios widgets, entre ellos: Button, TextView y Toast para el diseño de la interfaz
```
...
```
### Al final se configuro el boton "igual" para que pueda realizar las operaciones.
```
